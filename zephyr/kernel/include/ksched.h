...
#else
static inline void z_reset_time_slice(struct k_thread *curr)
{
	ARG_UNUSED(curr);
}

static inline int32_t z_get_thread_timeslice_ticks(struct k_thread *thread)
{
	ARG_UNUSED(thread);
	return 0;
}

static inline void z_time_slice_yield(void)
{
}
#endif
