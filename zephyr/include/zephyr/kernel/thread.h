...
enum z_thread_sched_policy {
	Z_THREAD_SCHED_OTHER = 0U,
	Z_THREAD_SCHED_FIFO = 1U,
	Z_THREAD_SCHED_RR = 2U,
};
...
struct _thread_base {
	...
	/* Scheduling policy used by the POSIX scheduler APIs and RR timeslicing. */
